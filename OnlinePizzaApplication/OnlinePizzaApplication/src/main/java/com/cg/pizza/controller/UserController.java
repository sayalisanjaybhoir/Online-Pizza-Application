...
public class UserController {
	...
	@PostMapping("/signOut")
	public ResponseEntity<String> userSignOut(@Valid @RequestBody User user, HttpServletRequest request) {
		HttpSession session = request.getSession();
		...
		return new ResponseEntity<String>("Sign Out succesfull, Bye admin: " + userData.getUserId(), HttpStatus.OK);
